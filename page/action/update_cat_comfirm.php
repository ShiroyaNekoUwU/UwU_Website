...
$sql_update_cat = "SELECT * FROM cat WHERE cat_id = '$cat'";
$result_update_cat = $conn->query($sql_update_cat);
$row_update_cat = $result_update_cat->fetch_assoc();

$old_name = $row_update_cat["cat_name"];
$old_introduction = $row_update_cat["introduction"];
$old_profile_photo = $row_update_cat["profile_photo"];
$old_state = $row_update_cat["state"];
...
<body>
    ...
    <main>
        <fieldset class="update_box cat">
            <legend>Update > <?php echo $_GET['cat'] ?></legend>
            <form action="update_cat_execute.php?cat=<?php echo $_GET['cat']; ?>" method="post" enctype="multipart/form-data">
                <div class="field">
